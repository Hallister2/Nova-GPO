...
def csv_report(
    ...
    writer.writerow(["Policy Name", "Status", "Scope", "Type", "Source", "Changes"])
...
def executive_summary(diff_items: list[PolicyDiff]) -> str:
    summary = _summary_counts(diff_items)
...
def markdown_report(
    ...
    report.append("")
    report.append(executive_summary(diff_items))
    report.append("")
